...
public class KanyaUserJob extends KanyaUserInfo{
    private Long id;

    private Long uid;

    private Integer education1;
    ...
    public Byte getJobMonthIncome() {
        return jobMonthIncome;
    }

    public void setJobMonthIncome(Byte jobMonthIncome) {
        this.jobMonthIncome = jobMonthIncome;
    }
