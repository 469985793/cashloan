...
<div style='height:40px;'>
    ...
    <div style='float: right ;'>编号：201711020000A5</div>
    <div style='height:1px;background:#000;clear: both'></div>
</div>
<h1 class="toph2" style="text-align: center;font-size: 24px;">三方协议（样板）</h1>
<div class="proto">
    <div class="text">
        <ul>
            <li>
    ...
    <div class="chidren">
        <ul>
            ...
            <li>2.	放款：本协议签订并生效后的5个工作日内，丙方根据甲方的授权将借款打入乙方如下银行账户（下称“乙方账户”）
                丙方依据本款规定实际向乙方账户支付了上述第一款规定的借款本金，则甲方在本协议项下的放款义务完成。丙方实际向乙方账户打款的日期即为放款日（下称“实际放款日”），如果实际放款日与借款明细表记载的放款日不一致，则以实际放款日为准，并且借款明细表中的最终到期日将根据实际放款日相应调整。对于实际放款日、实际最终到期日，乙方可以通过丙方平台查询。甲方委托丙方向乙方放款的相关约定由甲方与丙方的相关协议规定。
            </li>
        </ul>
    </div>
    <h2>二、还款</h2>
    ...
    <div class="chidren">
        <ul>
            <li>1.	乙方应在还款日向丙方支付一次性服务费（下称“一次性服务费”）。乙方应保证乙方账户有足够的资金，并不可撤销地授权丙方从乙方账户中将一次性服务费划转至丙方账户。
    ...
    <div class="chidren">
        <ul>
            <li>本协议的签订、履行、终止、解释均适用中国法律。各方同意，因本协议所产生的或与本协议有关的一切争议，各方应协商解决；协商无法达成一致的，均应提交协议签约地所在的厦门海沧区人民法院进行诉讼。</li>
        </ul>
    </div>
    <h2>十、其他</h2>
    <div class="chidren">
