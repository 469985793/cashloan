...
import com.xindaibao.cashloan.cl.Util.HttpUtil;
...
public class BorrowRepayServiceImpl extends BaseServiceImpl<BorrowRepay, Long> implements BorrowRepayService {
    ...
    @Override
    public int confirmRepay(Map<String, Object> param) {
        int returnCode = 0;
        int code = 0;
        ...
        params.put("transactionNo", param.get("thirdFlowNo"));
        params.put("mobile",mobile);
        params.put("transactionAmount",param.get("actualbackAmt"));
        params.put("remark",param.get("remark"));
        params.put("operatorId",param.get("sysRole"));
        params.put("completionTime",param.get("repayTime"));
        String returnBack =  HttpUtil.post("http://localhost:6081/mpesa/c2b/callback/offline", params);
