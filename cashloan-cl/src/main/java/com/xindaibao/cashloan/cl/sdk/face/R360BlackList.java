...
import com.xindaibao.cashloan.cl.sdk.face.model.R360BlackListBizData;
...
public class R360BlackList {
    ...
    public static String request(UserBaseInfo baseInfo) throws Exception {
        ...
        String rong360_black_list_mothed = (String)configMap.get("rong360_black_list_method");
       ...
       /* String rong360_url = "https://openapi.rong360.com/gateway";
        ...
        String rong360_black_list_mothed = "tianji.api.agentr.blacklist";*/


        HashMap<String, String> params = new HashMap<>();
        params.put("method", rong360_black_list_mothed);
        ...
        R360BlackListBizData r360BlackListBizData = new R360BlackListBizData();
        r360BlackListBizData.setIdNumber(baseInfo.getIdNo());
        r360BlackListBizData.setName(baseInfo.getRealName());
        r360BlackListBizData.setPhone(baseInfo.getPhone());
        params.put("biz_data", JSON.toJSONString(r360BlackListBizData));
