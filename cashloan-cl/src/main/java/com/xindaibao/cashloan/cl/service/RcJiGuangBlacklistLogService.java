 ...
 *
 */
public interface RcJiGuangBlacklistLogService extends BaseService<RcJiGuangBlacklistLog, Long>{

	int queryJiGuangBlackList(Borrow borrow, TppBusiness business);
}
