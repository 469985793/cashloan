...
public class RiskItems {
	...
	public RiskItems(String user_info_mercht_userno,
			String user_info_bind_phone, String user_info_dt_register,
			String user_info_full_name, String user_info_id_no) {
		super();
		this.frms_ware_category = "2010";
		...
		this.user_info_identify_type = "1";
		this.user_info_identify_state = "1";
	}
