...
public class RepaymentModel extends BasePaymentModel {
	...
	public RepaymentModel(String orderNo, String type) {
		super();
		if("fast".equalsIgnoreCase(type)){
			...
			this.setService("repayment");
			this.setApi_version(LianLianConstant.API_VERSION);
			this.setVersion(LianLianConstant.API_VERSION);
			this.setPay_type(LianLianConstant.PAY_TYPE_CERTIFIED);
			this.setSubUrl("https://wap.lianlianpay.com/payment.htm");
		}else {
			this.setOrderNo(orderNo);
			this.setNo_order(orderNo);
			this.setService("repayment");
			...
			this.setVersion(LianLianConstant.API_VERSION);
			this.setPay_type(LianLianConstant.PAY_TYPE_CERTIFIED);
			this.setSubUrl("https://wap.lianlianpay.com/authpay.htm");
		}
	...
	@Override
	public String[] signParamNamesToH5() {
...
//				"no_agree",
	...
	@Override
	public String[] signParamNamesFast() {
