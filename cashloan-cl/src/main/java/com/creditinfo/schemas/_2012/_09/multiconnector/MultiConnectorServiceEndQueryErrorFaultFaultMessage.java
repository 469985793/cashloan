...
public class MultiConnectorServiceEndQueryErrorFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public MultiConnectorServiceEndQueryErrorFaultFaultMessage(String message, Error faultInfo) {
        super(message);
     ...
     * @param message
     */
    public MultiConnectorServiceEndQueryErrorFaultFaultMessage(String message, Error faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
