...
public class MultiConnectorServiceQueryTimeoutFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public MultiConnectorServiceQueryTimeoutFaultFaultMessage(String message, Timeout faultInfo) {
        super(message);
     ...
     * @param message
     */
    public MultiConnectorServiceQueryTimeoutFaultFaultMessage(String message, Timeout faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
