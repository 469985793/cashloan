...
var Lookdetails = React.createClass({
                ...
                onOk: function () {
                    Utils.ajaxData({
                        ...
                        data: {
                            ...
                            thirdFlowNo:values.thirdFlowNo,
    ...
    :
        ...
        <Radio key="a" value={1}>Normal repayment</Radio>{/*正常还款*/}
        <Radio key="b" value={2}>Amount reduction</Radio>{/*金额减免*/}
        </RadioGroup>
        </FormItem>
        </Col>
        </Row>
        ...
        <Col span="0">
            ...
            <Input type="text" placeholder="Please enter your bank card number or Alipay account number" {...getFieldProps('repayAccount', { rules: [{ required: false, message: "Too much input or not lost", max: 20 }] })} />{/*请输入银行卡号或者支付宝账号   输入过多或者未输*/}
        </FormItem>
        </Col>
        </Row>
        <Row>
        <Col span="24">
            <FormItem {...formItemLayout} label="Third Flow No:">{/*第三方流水号*/}
            <Input type="text" placeholder="Please enter your third flow number" {...getFieldProps('thirdFlowNo', { rules: [{ required: true, message: "Too much input or not lost", max: 20 }] })} />{/*请输入银行卡号或者支付宝账号   输入过多或者未输*/}
        </FormItem>
        </Col>
        </Row>
        <Row>
        <Col span="24">
            <FormItem {...formItemLayout} label="Remark:">{/*备注*/}
            <Input type="text" placeholder="Please enter your remark" {...getFieldProps('remark', { rules: [{ required: true, message: "Too much input or not lost", max: 20 }] })} />{/*请输入银行卡号或者支付宝账号   输入过多或者未输*/}
        </FormItem>
        </Col>
        </Row>
        <Row>
        <Col span="0">
            ...
            <Select placeholder="Please Choose" {...getFieldProps('repayWay', { rules: [{ required: false, message: '必填', type: 'string' }] })} >{/*请选择*/}
        ...
        <Col span="0">
            ...
            <Input type="text" placeholder="Please enter the serial number" {...getFieldProps('serialNumber', { rules: [{ required: false, message: "Too much input or not lost" }] })} />{/*请输入流水号    输入过多或者未输*/}
        </FormItem>
        </Col>
        </Row>
        <Row>
