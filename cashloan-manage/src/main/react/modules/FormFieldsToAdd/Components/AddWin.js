                            ...
                            <Row>
                               <Col span="12">
                                    <FormItem  {...formItemLayout} label="字段:">
                                     <Select style={{ width: '600px' }} disabled={props.title=="编辑"?props.canEdit:this.state.canEdit} multiple onSelect={this.select} {...getFieldProps('detail', {  initialValue:this.state.dataName ,rules: [{required:true,message:'必填',type:'array'}]})} > 
                                           {state.dataArray}
                                     </Select> 
                                    </FormItem>
                              </Col>
